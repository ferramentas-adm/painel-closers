...
if (!columns.includes("ultimo_heartbeat")) {
  db.exec("ALTER TABLE colaboradores ADD COLUMN ultimo_heartbeat INTEGER");
}
if (!columns.includes("status_origem")) {
  db.exec("ALTER TABLE colaboradores ADD COLUMN status_origem TEXT");
}
